...
import SectionPortada from "./Sections/SectionPortada.jsx";
import SectionItems from "./Sections/SectionItems.jsx";
...
class MinasPage extends React.Component {
  // componentDidMount() {
    ...
    return (
      <div>
        <Header
          color="white"
          brand={ <img
            src={require("assets/img/minas/unsa.png")}
            alt="Logo"
            style={{ height: "50px" }}
          ></img>}
        ...
        <div className={classes.main}>
          <SectionPortada id="inicio" />
          <SectionItems id="features" />
          {/* 
...
export default withStyles(sectionsPageStyle)(MinasPage);
